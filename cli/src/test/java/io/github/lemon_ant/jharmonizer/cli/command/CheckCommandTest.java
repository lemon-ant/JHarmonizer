...
class CheckCommandTest {
    ...
    @Test
    void checkCommand_withBaseDirOption_invokesProcessorWithCorrectBaseDir() {
        // Given
    ...
    @Test
    void checkCommand_whenChangesDetected_returnsExitCode3() {
        // Given
        SourceProcessor mockProcessor = mock(SourceProcessor.class);
    ...
    @Test
    void checkCommand_whenOrderingChangesDetected_returnsExitCode3() {
        // Given
        SourceProcessor mockProcessor = mock(SourceProcessor.class);
        when(mockProcessor.processSources(any(Path.class), any(), any(), any()))
    ...
    @Test
    void checkCommand_whenNoChangesDetected_returnsExitCode0() {
        // Given
        SourceProcessor mockProcessor = mock(SourceProcessor.class);
