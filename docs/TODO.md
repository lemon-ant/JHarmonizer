...
### 3. Record-member ordering policies (future version)
...
### 4. Vendor-format configuration adapters (IntelliJ IDEA, Eclipse, EditorConfig, Spotless)
...
### 5. Git-aware changed-files processing mode (future version)
...
### 6. Automatic fully-qualified name optimizer (future version)
...
### 7. Adaptive static-import optimizer (future version)
...
### 9. JUnit 5 test visibility normalizer (future version)
...
### 10. Automatic constant naming convention enforcer (`UPPER_SNAKE_CASE`) (future version)
...
### 11. Nullability interfaces / annotations enforcer (future version)
...
### 12. Lombok policy enforcer and optimizer (future version)
...
### 14. Static-candidate conversion analyzer (instance -> static) (future version)
...
### 15. Override-aware parameter ordering harmonizer for methods and constructors (future version)
...
### 16. Collapse single-value annotation array braces (future version)
...
### 17. Add a type-based selector to rule lines (field type / method return type)
...
### 18. Package dependency cycle detector (future version)
...
### 19. Flexible logging-level controls for CLI, wrappers, and public API (future version)
...
### 20. Constants ordering expansion (future version)
