...
class ZuluImportHelper {
    static String label() {
        return "zulu-import";
    }
}

public class FileSortOffBetweenPackageAndImports {
    int zebra;
    ...
    public static void main(String[] args) {
        System.out.println(new FileSortOffBetweenPackageAndImports().describe());
    }
    ...
    String describe() {
        ...
        return String.join("-", labels) + zebra + ant + ZuluImportHelper.label() + BetaImportHelper.label();
    }
}
