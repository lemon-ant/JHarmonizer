...
class NestedEnumCrossTypeBackReferenceRegressionSample {
    ...
    public static void main(String[] args) {
        if (!"File Filter/Recurse Subdirectories".equals(MODE_VALUE)) {
            throw new IllegalStateException("Expected 'File Filter/Recurse Subdirectories' but was: " + MODE_VALUE);
        }
    }

    enum NestedBackRefMode {
        FILTER_ALL(NestedEnumCrossTypeBackReferenceRegressionSample.FILTER_LABEL
                + "/"
