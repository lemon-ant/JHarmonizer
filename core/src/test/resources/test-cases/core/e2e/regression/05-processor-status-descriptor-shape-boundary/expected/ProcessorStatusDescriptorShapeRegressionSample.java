...
public enum ProcessorStatusDescriptorShapeRegressionSample {
    FLOWFILES_REMOVED(value -> value, null, false),

    OUTPUT_COUNT(value -> value, null, false),
    ...
    ProcessorStatusDescriptorShapeRegressionSample(
            final ValueProvider valueFunction, final ValueReducer reducer, final boolean visible) {
    ...
    private static final class MetricDescriptor {
        ...
        private MetricDescriptor(
                final IntProvider indexProvider, final ValueProvider valueProvider, final ValueReducer valueReducer) {
