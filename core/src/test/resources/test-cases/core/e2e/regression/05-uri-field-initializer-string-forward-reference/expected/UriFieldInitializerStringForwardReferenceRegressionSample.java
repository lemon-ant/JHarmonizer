...
class StandardHttpUriBuilderTest {
    ...
    private static final URI HTTP_LOCALHOST_PORT_ENCODED_PATH_URI =
            URI.create(String.format("%s://%s:%d%s", HTTP_SCHEME, LOCALHOST, PORT, ENCODED_PATH));
    private static final String PATH_WITH_SPACES_ENCODED = "/resources/%20separated%20search";
    private static final URI HTTP_LOCALHOST_PORT_ENCODED_PATH_WITH_SPACES_AND_SEGMENTS_URI = URI.create(String.format(
            "%s://%s:%d%s/%s/%s",
            HTTP_SCHEME, LOCALHOST, PORT, PATH_WITH_SPACES_ENCODED, BUCKETS_PATH_SEGMENT, FILES_PATH_SEGMENT));
    private static final URI HTTP_LOCALHOST_PORT_ENCODED_PATH_WITH_SPACES_URI =
            URI.create(String.format("%s://%s:%d%s", HTTP_SCHEME, LOCALHOST, PORT, PATH_WITH_SPACES_ENCODED));
    private static final URI HTTP_LOCALHOST_PORT_ENCODED_PATH_WITH_TRAILING_SEPARATOR_AND_SEGMENTS_URI =
            URI.create(String.format(
                "%s://%s:%d%s%s/%s",
                HTTP_SCHEME,
                LOCALHOST,
                PORT,
                ENCODED_PATH_WITH_TRAILING_SEPARATOR,
                BUCKETS_PATH_SEGMENT,
                FILES_PATH_SEGMENT));
    ...
    private static final URI HTTP_LOCALHOST_QUERY_PARAMETER_VALUE_URI = URI.create(String.format(
            "%s?%s=%s", HTTP_LOCALHOST_RESOURCES_URI, SECOND_PARAMETER_NAME, SECOND_PARAMETER_VALUE_ENCODED));
    ...
    private static final URI HTTP_LOCALHOST_QUERY_REPEATED_URI = URI.create(String.format(
            "%s?%s&%s", HTTP_LOCALHOST_RESOURCES_URI, PARAMETER_NAME_AND_VALUE, PARAMETER_NAME_AND_VALUE));
    ...
    private static final URI HTTP_LOCALHOST_QUERY_URI =
            URI.create(String.format("%s?%s", HTTP_LOCALHOST_RESOURCES_URI, PARAMETER_NAME_AND_VALUE));
    ...
    private static final URI HTTP_LOCALHOST_RESOURCES_SEPARATED_URI =
            URI.create(String.format("%s%s", HTTP_LOCALHOST_URI, RESOURCES_PATH_SEGMENT_SEPARATED_ENCODED));
