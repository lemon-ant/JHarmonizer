...
public class FileSortOffFloatingAfterImportsAttachesToFirstType {
    int zebra;
    ...
    public static void main(String[] args) {
        System.out.println(new FileSortOffFloatingAfterImportsAttachesToFirstType().describe());
    }
    ...
    String describe() {
        ...
        return String.join("-", labels) + zebra + ant + AlphaAttachmentHelper.label();
    }
}
