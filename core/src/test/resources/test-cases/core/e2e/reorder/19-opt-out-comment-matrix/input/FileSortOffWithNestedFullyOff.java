...
public class FileSortOffWithNestedFullyOff{int walrus;
    static class ZetaNested{String label(){return "zeta";}}
    int aardvark;
    static String suffix(){return new BetaNested().label()+new ZetaNested().label()+ZuluHelper.label()+AlphaHelper.label();}
    static class BetaNested{String label(){return "beta";}}
